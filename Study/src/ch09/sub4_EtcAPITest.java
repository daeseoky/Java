...
public class sub4_EtcAPITest {
	public static void main(String[] args) {
		...
		System.out.println("반올림1.2 : "+Math.round(1.2));
		System.out.println("반올림1.8 : "+Math.round(1.8));
		
		double num1 = Math.random();
		System.out.println("num1 : "+num1);  //  0~1사이의 임의의 수
		
		double num2 = num1 * 10;
		System.out.println("num2 : "+num2);  //  0~10사이의 임의의 수
		
		double num3 = Math.ceil(num2);
		System.out.println("num3 : "+num3);  //  0~10사이의 임의의 정수
